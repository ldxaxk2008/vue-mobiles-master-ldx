            ...
            <div class="register-content">
              ...
              <div>
                <form class="register-content__info" ref="registerform" :model="registerlist" >
                  <div><input type="text" v-model="registerlist.name" placeholder="公司名称"></div>
                  <div><input type="text" v-model="registerlist.school" placeholder="工商编号"></div>
                  <div><input type="text" v-model="registerlist.grade" placeholder="联系人"></div>
                  <div><input type="text" v-model="registerlist.email" placeholder="联系邮箱"></div>
